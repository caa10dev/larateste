                            ...
                            <div class="col-xs-12 col-md-6 col-lg-3">
                                <div class="form-group">
                                    <div class="input-group">
                                        ...
                                        <input type="text" class="form-control" name="search" placeholder="Nome do Usuário" value="{{\Request::get('search')}}">
                                    </div>
                                </div>
                            </div>
                            <div class="col-xs-12 col-md-6 col-lg-3">
                ...
                <div class="row">
                    <div class="col-xs-12 text-right">
                        <span class="input-group-btn">
                            <a href="{{ route('users.create') }}" class="btn bg-teal btn-flat"> <i class="glyphicon glyphicon-plus-sign"></i> Criar Usuário</a>
                        </span>
                    </div>
                </div>
                <br>
